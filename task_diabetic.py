...
dnaTest = np.genfromtxt(DATA_PATH + 'diab-testIn.ssv', delimiter=' ')
# label ?
print ( 'Loading label file...')  
dnaVal = np.genfromtxt(DATA_PATH+ 'diab-valIn.ssv', delimiter=' ')
# train 
print ( 'Loading train file...')  
dnaTrain = np.genfromtxt(DATA_PATH+ 'diab-trainIn.ssv', delimiter=' ')
